...
FROM invoices
WHERE sender_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND status = 'sent'
...
FROM invoices
WHERE sender_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND invoice_number IS NOT NULL
...
SELECT 'B3. nummer-gaten (teller vs uitgegeven)' AS check,
       ...
       (SELECT count(*) FROM invoices i
          WHERE i.sender_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND i.invoice_number IS NOT NULL
...
WHERE c.user_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid;
...
WHERE user_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND status = 'pending'
...
FROM bank_transactions
WHERE user_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND category IS NULL;
...
FROM invoices
WHERE (receiver_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid OR sender_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid);
...
FROM invoices
WHERE sender_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND direction = 'outgoing'
...
FROM bank_transactions
WHERE user_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND date >= date_trunc('year', now());
...
FROM daily_turnover
WHERE user_id = 'ac22189e-7052-4c48-b4ec-90947cf92ecc'::uuid AND turnover_date >= date_trunc('year', now());
