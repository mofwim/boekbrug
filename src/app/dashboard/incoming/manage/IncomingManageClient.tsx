        ...
        <BottomSheet
          ...
          body={
            ...
            bundlePayRows.some(r => (r.total_inc_btw ?? 0) < 0)
              ? `De geselecteerde inkoopfacturen van ${bundlePayRows[0]?.client_name ?? 'deze leverancier'} worden afgerond. De creditnota's zijn met deze betaling verrekend en gaan mee dicht — anders zou je ze een tweede keer aftrekken.`
              : `De geselecteerde inkoopfacturen van ${bundlePayRows[0]?.client_name ?? 'deze leverancier'} worden allemaal als betaald gemarkeerd.`
          }
