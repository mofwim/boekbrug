...
// src/app/dashboard/werkplek/ZzpWerkplek.tsx
// [BOEK-029] Material You design — extracted from werkplek/page.tsx — May 2026
...
export default function ZzpWerkplek() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F8F9FA', fontFamily: FONT, WebkitFontSmoothing: 'antialiased' }}>
      ...
      <div style={{
        ...
        <button onClick={() => router.back()} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4, color: M3.primary, fontWeight: 600, fontSize: 14, padding: 0, fontFamily: FONT }}>
      ...
      <main style={{ maxWidth: 480, margin: '0 auto', padding: '20px 16px 80px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {ITEMS.map(item => (
            ...
            >
              <div style={{ width: 50, height: 50, borderRadius: R.md, background: item.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
