// src/app/dashboard/resultaat/loading.tsx
...
// The container width matches resultaat's own so nothing shifts sideways when the
// real content lands. See docs/MOTION_SYSTEM.md and docs/UX_REVIEW_2026.md.

import { SkeletonPage, SkeletonLine, SkeletonCard, SkeletonStats } from '@/components/ui/PageSkeleton'
