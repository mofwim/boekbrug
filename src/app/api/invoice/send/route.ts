...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    //
    // [NAMENS] Op het BEDRIJF, anders zou een tweede medewerker een tweede gratis maand zijn.
    // De planlezing gaat dan langs service_role: het profiel van de eigenaar is voor de sessie
    // van een medewerker onleesbaar, en een mislukte plandetectie zou hem stilzwijgend op het
    // gratis plan zetten.
