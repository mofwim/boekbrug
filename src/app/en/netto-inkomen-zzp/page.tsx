    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa', fontFamily: 'var(--font-sans), system-ui, sans-serif' }}>
      ...
      <div style={{ ...wrap, paddingTop: 40, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 14, margin: '0 0 28px' }}>
          <Link href="/netto-inkomen-zzp" style={{ color: '#1a73e8', textDecoration: 'none', fontWeight: 600 }}>
      ...
      <div style={{ ...wrap, paddingBottom: 64 }}>
        ...
        <section style={{ marginTop: 32, background: '#ffffff', border: '1px solid #ececf1', borderRadius: 16, padding: 24, textAlign: 'center' }}>
          <div style={{ fontSize: 18, fontWeight: 700, color: '#202124', marginBottom: 6 }}>Know where you stand all year</div>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/en/blog" style={{ backgroundColor: '#fff', color: '#1a73e8', fontSize: 15, fontWeight: 600, padding: '12px 22px', borderRadius: 9999, border: '1.5px solid #1a73e8', textDecoration: 'none' }}>Read the blog</Link>
          </div>
        </section>
