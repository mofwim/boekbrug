...
const SENTENCE_KEYS: readonly MessageKey[] = [
  ...
  "log.invoice.reread_from_document", "log.invoice.reimported", "log.invoice.btw_rows_read",
  ...
  "log.work.created", "log.work.status_changed", "log.work.invoiced", "log.work.deleted",
